    ...
    <form action="{{ route('admin.produk.update', $product->kode_produk) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="material[]" class="form-control" placeholder="Masukkan Kode Material" value="{{ $bom->kode_bk }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Contoh : 250 atau 0.2" name="keb[]" value="{{ $bom->kebutuhan }}" required>
                            </div>
                        </div>
                    </div>
                    @php $index++; @endphp
                ...
                {{-- Sisa slot kosong jika jumlah BOM lebih sedikit dari total material --}}
                @for($i = $index; $i < count($materials); $i++)
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Kode Material</label>
